...
it could never have refused anything. It lives in supervisor-mode LESSONS.md, on the
ALREADY_ENCODED line that graduated L11 on 2026-09-20, so grep `consumed cap`
