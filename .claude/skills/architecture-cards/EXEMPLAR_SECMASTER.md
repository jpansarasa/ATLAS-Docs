...
SEE: README §Reference (API endpoints, config tables) · secmaster.proto · EntityResolutionService.cs:1428(ContextFactor) · ResolutionService.cs(ranking) · RegistrationService.cs:189(EvaluateGuard)
