...
## ETHOS
snapshot_first # memory dir is NOT in git — without the snapshot one bad sed is unrecoverable
verify_by_diff ¬ trust_agent_self_report
compress_lines ∧ flag_retirement ¬ auto_delete # entry COUNT drives bloat more than line length; deletion = human judgment
