...
- **THIS LANDS ON D-18's GUARD SITE. The design story MUST carry `supersedes D-18` or STOP.**
  ...
  the RULE is one line at `SentinelCollector/AGENT_README.md` §D-18 and the ~2,000-word entry it
  was condensed from is `SentinelCollector/DECISIONS.md` §D-18 -- **read BOTH before designing**;
