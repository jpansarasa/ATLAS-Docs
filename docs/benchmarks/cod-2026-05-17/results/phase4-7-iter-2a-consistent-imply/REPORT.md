...
_Generated: 2026-05-25T15:16:18Z_
...
- Per-CLAIM verdicts compared: **137** (agree=86, disagree=51, foundry-missing=0)

## 2. Acceptance gate (§7.3, ≥85% agreement)

**Result:** **FAIL** — agreement = 0.6277 (62.77%); gate = ≥85%
...
- **production=none / foundry=partial:** 19
- **production=full / foundry=partial:** 12
- **production=partial / foundry=full:** 9
- **production=partial / foundry=none:** 7
...
- Production-arm total wall-time across n=50: **90027 ms** (90.0 s for 137 CLAIM calls).
...
- Sample ids: `results/phase4-7-iter-2a-consistent-imply/sample_ids.txt`
- Production enriched docs: `results/phase4-7-iter-2a-consistent-imply/v2_pipeline/*.json` (47 files)
- Foundry labels: `results/phase4-7-iter-2a-consistent-imply/foundry_labels/*.json` (47 files)
- Per-CLAIM spot check (long form): `results/phase4-7-iter-2a-consistent-imply/spot_check.jsonl` (137 rows)
- This report: `results/phase4-7-iter-2a-consistent-imply/REPORT.md`
