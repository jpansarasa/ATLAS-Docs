...
_Generated: 2026-05-25T15:48:46Z_
...
- Per-CLAIM verdicts compared: **137** (agree=69, disagree=68, foundry-missing=0)

## 2. Acceptance gate (§7.3, ≥85% agreement)

**Result:** **FAIL** — agreement = 0.5036 (50.36%); gate = ≥85%
...
- **production=none / foundry=partial:** 37
- **production=full / foundry=partial:** 11
...
- Production-arm total wall-time across n=50: **108692 ms** (108.7 s for 137 CLAIM calls).
