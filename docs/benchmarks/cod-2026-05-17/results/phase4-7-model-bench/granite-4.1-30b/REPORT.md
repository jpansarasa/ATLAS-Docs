...
_Generated: 2026-05-25T18:01:06Z_
...
- Per-CLAIM verdicts compared: **137** (agree=77, disagree=60, foundry-missing=0)

## 2. Acceptance gate (§7.3, ≥85% agreement)

**Result:** **FAIL** — agreement = 0.5620 (56.20%); gate = ≥85%
...
- **production=none / foundry=full:** 7
...
- Production-arm total wall-time across n=50: **20210 ms** (20.2 s for 137 CLAIM calls).
...
- Production enriched docs: `results/phase4-7-model-bench/granite-4.1-30b/v2_pipeline/*.json` (47 files)
- Foundry labels: `results/phase4-7-model-bench/foundry_labels/*.json` (47 files)
- Per-CLAIM spot check (long form): `results/phase4-7-model-bench/granite-4.1-30b/spot_check.jsonl` (137 rows)
- This report: `results/phase4-7-model-bench/granite-4.1-30b/REPORT.md`
