...
_Generated: 2026-05-25T15:13:12Z_
...
- Per-CLAIM verdicts compared: **137** (agree=93, disagree=44, foundry-missing=0)

## 2. Acceptance gate (§7.3, ≥85% agreement)

**Result:** **FAIL** — agreement = 0.6788 (67.88%); gate = ≥85%
...
- **production=none / foundry=partial:** 23
- **production=partial / foundry=full:** 9
- **production=partial / foundry=none:** 6
- **production=none / foundry=full:** 5
- **production=full / foundry=none:** 1
...
- Production-arm total wall-time across n=50: **89398 ms** (89.4 s for 137 CLAIM calls).
...
- Sample ids: `results/phase4-7-iter-2/sample_ids.txt`
- Production enriched docs: `results/phase4-7-iter-2/v2_pipeline/*.json` (47 files)
- Foundry labels: `results/phase4-7-iter-2/foundry_labels/*.json` (47 files)
- Per-CLAIM spot check (long form): `results/phase4-7-iter-2/spot_check.jsonl` (137 rows)
- This report: `results/phase4-7-iter-2/REPORT.md`
