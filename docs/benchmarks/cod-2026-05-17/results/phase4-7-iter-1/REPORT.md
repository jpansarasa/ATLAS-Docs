...
_Generated: 2026-05-25T15:06:27Z_
...
- **production=partial / foundry=none:** 14
- **production=none / foundry=partial:** 12
- **production=partial / foundry=full:** 12
- **production=none / foundry=full:** 2
...
- Production-arm total wall-time across n=50: **107330 ms** (107.3 s for 137 CLAIM calls).
...
- Sample ids: `results/phase4-7-iter-1/sample_ids.txt`
- Production enriched docs: `results/phase4-7-iter-1/v2_pipeline/*.json` (47 files)
- Foundry labels: `results/phase4-7-iter-1/foundry_labels/*.json` (47 files)
- Per-CLAIM spot check (long form): `results/phase4-7-iter-1/spot_check.jsonl` (137 rows)
- This report: `results/phase4-7-iter-1/REPORT.md`
