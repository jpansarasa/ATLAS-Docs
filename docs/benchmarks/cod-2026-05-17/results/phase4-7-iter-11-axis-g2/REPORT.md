...
_Generated: 2026-05-25T16:48:39Z_
...
- Per-CLAIM verdicts compared: **137** (agree=94, disagree=43, foundry-missing=0)

## 2. Acceptance gate (§7.3, ≥85% agreement)

**Result:** **FAIL** — agreement = 0.6861 (68.61%); gate = ≥85%
...
- Production-arm total wall-time across n=50: **118732 ms** (118.7 s for 137 CLAIM calls).
...
- Sample ids: `results/phase4-7-iter-11-axis-g2/sample_ids.txt`
- Production enriched docs: `results/phase4-7-iter-11-axis-g2/v2_pipeline/*.json` (47 files)
- Foundry labels: `results/phase4-7-iter-11-axis-g2/foundry_labels/*.json` (47 files)
- Per-CLAIM spot check (long form): `results/phase4-7-iter-11-axis-g2/spot_check.jsonl` (137 rows)
- This report: `results/phase4-7-iter-11-axis-g2/REPORT.md`
