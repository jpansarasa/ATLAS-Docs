...
_Generated: 2026-05-25T15:59:57Z_
...
- Per-CLAIM verdicts compared: **137** (agree=96, disagree=41, foundry-missing=0)

## 2. Acceptance gate (§7.3, ≥85% agreement)

**Result:** **FAIL** — agreement = 0.7007 (70.07%); gate = ≥85%
...
- **production=partial / foundry=none:** 25
- **production=partial / foundry=full:** 14
- **production=none / foundry=partial:** 2
...
- Production-arm total wall-time across n=50: **117683 ms** (117.7 s for 137 CLAIM calls).
