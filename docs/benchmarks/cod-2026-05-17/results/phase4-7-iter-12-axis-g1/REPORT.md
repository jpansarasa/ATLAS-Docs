...
_Generated: 2026-05-25T16:54:54Z_
...
- Per-CLAIM verdicts compared: **137** (agree=58, disagree=79, foundry-missing=0)

## 2. Acceptance gate (§7.3, ≥85% agreement)

**Result:** **FAIL** — agreement = 0.4234 (42.34%); gate = ≥85%
...
- **production=none / foundry=partial:** 59
...
- Production-arm total wall-time across n=50: **75531 ms** (75.5 s for 137 CLAIM calls).
...
- Sample ids: `results/phase4-7-iter-12-axis-g1/sample_ids.txt`
- Production enriched docs: `results/phase4-7-iter-12-axis-g1/v2_pipeline/*.json` (47 files)
- Foundry labels: `results/phase4-7-iter-12-axis-g1/foundry_labels/*.json` (47 files)
- Per-CLAIM spot check (long form): `results/phase4-7-iter-12-axis-g1/spot_check.jsonl` (137 rows)
- This report: `results/phase4-7-iter-12-axis-g1/REPORT.md`
