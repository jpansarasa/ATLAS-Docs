...
_Generated: 2026-05-25T15:42:18Z_
...
- Per-CLAIM verdicts compared: **137** (agree=90, disagree=47, foundry-missing=0)

## 2. Acceptance gate (§7.3, ≥85% agreement)

**Result:** **FAIL** — agreement = 0.6569 (65.69%); gate = ≥85%
...
- **production=none / foundry=partial:** 20
- **production=partial / foundry=full:** 12
- **production=partial / foundry=none:** 11
...
- Production-arm total wall-time across n=50: **114476 ms** (114.5 s for 137 CLAIM calls).
