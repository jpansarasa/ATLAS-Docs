# Phase 4.7s.4 diagnostic — baseline (no LoRA) eval REPORT — variant `iter_fresh_9_oneshot_trap`

Generated: 2026-05-26T11:52:39Z

## Run

- variant: `iter_fresh_9_oneshot_trap`
- endpoint: `http://localhost:8000/v1/completions`
- model: `Qwen/Qwen2.5-32B-Instruct-AWQ` (base, **no LoRA adapter**)
- max_tokens: 64 | temperature: 0.0
- concurrency: 8
- rows: completed 1560 / requested 1560 (errors 0)
- wall time: 191.5s (8.14 calls/s)
...
- macro F1: 0.4618
- micro F1: 0.7269
- Foundry-agreement subset (n=563): **0.6927**

### Per-class metrics

| label | precision | recall | F1 | support |
|---|---:|---:|---:|---:|
| consistent | 0.778 | 0.635 | 0.699 | 419 |
| related | 0.516 | 0.237 | 0.325 | 198 |
| unrelated | 0.729 | 0.945 | 0.823 | 869 |
...
|---|---:|---:|---:|---:|
| consistent | 266 | 26 | 127 | 0 |
| related | 22 | 47 | 129 | 0 |
| unrelated | 32 | 15 | 821 | 1 |
| insufficient_evidence | 22 | 3 | 49 | 0 |

### Top disagreement cells

| true | pred | count |
|---|---|---:|
| related | unrelated | 129 |
| consistent | unrelated | 127 |
| insufficient_evidence | unrelated | 49 |
| unrelated | consistent | 32 |
| consistent | related | 26 |

## 4-way comparison

| run | test set | accuracy | Foundry agreement |
|---|---|---:|---:|
| **this run — variant `iter_fresh_9_oneshot_trap`** | v3/test_holdout n=1560 | **0.7269** | **0.6927** |
...
- Δ accuracy vs iter5 baseline: **+23.65 pp**
- Δ Foundry agreement vs iter5 baseline: **+33.75 pp**
