...
Generated: 2026-05-25T19:34:18Z
Seed: 17
...
## Held-out article pool (SHORT (corpus yield gap))

- target: 100
- actual: 25
- excluded iter sweep: iter-1..10 v2_pipeline article_ids
- pool source: corpus.full72.jsonl
- sample IDs (first 10): 27548, 29581, 29845, 30273, 30350, 30619, 31629, 32270, 32360, 32859

## Foundry candidate pool (Phase 4.7s.3 input)

- 137 CLAIMs identified for cloud labeling
...
* The held-out pool FELL SHORT of n=100. corpus.full72 has 72 articles; iter-1..10 used 47, leaving 25 fresh. Supervisor decision required: lower test n OR expand corpus.
